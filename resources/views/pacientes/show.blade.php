        ...
        <div class="max-w-6xl mx-auto">
            ...
            @if($paciente->obrasSociales && $paciente->obrasSociales->count() > 0)
                <div class="bg-white shadow rounded-lg p-6 mt-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Obras Sociales</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @foreach($paciente->obrasSociales as $obra)
                            <div class="border border-gray-200 rounded-lg p-4">
                                <h3 class="font-medium text-gray-900">{{ $obra->nombre }}</h3>
            ...
            @if($paciente->historiasClinicas && $paciente->historiasClinicas->count() > 0)
                <div class="bg-white shadow rounded-lg p-6 mt-6">
                    <h2 class="text-xl font-semibold text-gray-900 mb-4">Historias Clínicas Recientes</h2>
                    <div class="space-y-4">
